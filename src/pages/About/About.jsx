        ...
        <div className="my-10">
          ...
          <div className="my-10 grid grid-cols-4">
            <Link
              ...
              target="_blank"
              className="flex items-center justify-center flex-col gap-3 border-r-4 border-r-secondary"
            >
              <FaFacebook size={50} className="text-secondary" />
            ...
            <Link
              ...
              className="flex items-center justify-center flex-col gap-3 border-r-4 border-r-secondary"
            >
              <FaGithub size={50} className="text-secondary" />
            ...
            >
              <FaYoutube size={50} className="text-secondary" />
